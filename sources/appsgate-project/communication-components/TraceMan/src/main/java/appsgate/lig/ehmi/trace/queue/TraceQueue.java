...
/**
 * TraceQueue is a dedicated queue for AppsGate JSON formatted traces.
 *
...
public class TraceQueue extends ArrayBlockingQueue<JSONObject> {
     ...
     */
    private final TraceExecutor traceExec;
    ...
    /**
     * Define the trace time width in milliseconds value to 0 means no
     * aggregation interval and each change is trace when it appear
     */
     ...
     * The parent manager
     */
    private final TraceMan manager;

    /**
     * Default TraceQueue constructor with max capacity set to 50000 elements
     *
     * @param manager
