...
public interface EHMIProxySpec {
     ...
     * @return true if the service account has been synchronized, false
     * otherwise
     */
     ...
     * as follow), example starting with Gre [
     * {"locality1":"Grenoble","woeid":"593720","name":"Grenoble","placeTypeName":"Town","country":"France"},
     * {"locality1":"Green Bay","woeid":"2413753","name":"Green
     * Bay","placeTypeName":"Town","country":"États-Unis"},
    ...
    /**
     * Try to create an Observer with an human friendly name to fetch Weather
     * conditions
     *
     * @param location A human place name : a town, a country, a particular
     * place or point of interest (poi)
    ...
    /**
     * Try to create an Observer with the explicit Yahoo WOEID (Where On Earth
     * IDentifier)
     *
     */
