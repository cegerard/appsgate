package appsgate.lig.extended.spec;
 ...
 * This one is almost the same as CoreObjectSpec, but is redefined for distinction of Types
 *
 */
public interface ExtendedObjectSpec {
