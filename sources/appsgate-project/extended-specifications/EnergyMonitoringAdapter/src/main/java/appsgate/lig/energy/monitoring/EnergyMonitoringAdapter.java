...
public interface EnergyMonitoringAdapter {
	 ...
	 * @param startDate starting date in millisecs from the epoch (01/01/1970) 
	 * @param endDate ending date in millisecs from the epoch (01/01/1970) 
	 * @param periodOffset in millisecs
	 * @param periodInterval in millisecs
	 * @return the groupID if the service was successfully created
	 */
	public String createGroup(String groupName,
			JSONArray sensors,
			double budgetTotal, double budgetUnit,
			long startDate, long endDate, long periodOffset, long periodInterval);
