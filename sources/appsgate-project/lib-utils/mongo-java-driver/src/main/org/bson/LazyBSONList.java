...
public class LazyBSONList extends LazyBSONObject implements List {
    ...
    public LazyBSONList(BSONByteBuffer buffer, int offset,
    ...
    @Override
    public int size() {
	// TODO check the last one and get the key/field name to see the ordinal
	// position in case the array is stored with missing elements.
