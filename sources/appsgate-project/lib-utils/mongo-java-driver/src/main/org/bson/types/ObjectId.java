...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
     ...
     * has done it this way for a long time, but it does not match the <a
     ...
     * To that end, the constructors that takes these three arguments are now
     * deprecated in favor of this more explicit factory method, and in the next
     * major release those constructors will be removed.
     * <p>
    ...
    /**
     * Constructs an ObjectId using time, machine and inc values. The Java
     ...
     * explicit factory method ObjectId#createFromLegacyFormat(int, int, int)},
     ...
     *             ObjectId specification</a>. Please use
     *             {@link org.bson.types.ObjectId#ObjectId(byte[])} or
     *             {@link ObjectId#createFromLegacyFormat(int, int, int)}
     *             instead.
     */
    @Deprecated
     ...
     * more explicit factory method ObjectId#createFromLegacyFormat(int, int,
     ...
     * 
     * @param s
     *            the string representation of ObjectId. Can contains only
     *            [0-9]|[a-f]|[A-F] characters.
     * @param babble
     *            if {@code true} - convert to 'babble' objectId format
     * 
     * @deprecated 'babble' format is deprecated. Please use
     *             {@link #ObjectId(String)} instead.
     */
    @Deprecated
    ...
    /**
     * @deprecated 'new' flag breaks the immutability of the {@code ObjectId}
