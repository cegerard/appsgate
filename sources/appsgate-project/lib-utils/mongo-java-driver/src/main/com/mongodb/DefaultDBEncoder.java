...
public class DefaultDBEncoder extends BasicBSONEncoder implements DBEncoder {
    ...
    /**
     * @deprecated Please see {@link DBPointer}. You can override
     *             {@link #putDBRef(String, DBRefBase)} if you need a specific
     *             behaviour while decoding database references.
     */
    @Deprecated
