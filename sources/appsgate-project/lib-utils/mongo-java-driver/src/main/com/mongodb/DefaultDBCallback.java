...
/**
 * This class overrides BasicBSONCallback to implement some extra features
 * specific to the Database. For example DBRef type.
 * 
 * @author antoine
 */
public class DefaultDBCallback extends BasicBSONCallback implements DBCallback {
	...
	if (c != null) {
		...
		throw new MongoInternalException("can't instantiate a : " + c,
			ie);
	...
	if (!(o instanceof List) && lastName != null && o.containsField("$ref")
		&& o.containsField("$id")) {
