...
public class ConnectionPoolStatisticsBean {
    ...
    public ConnectionPoolStatisticsBean(final int total, final int inUse,
	    final InUseConnectionBean[] inUseConnections) {
    ...
    /**
     * Gets an array of beans describing all the connections that are currently
     * in use.
     * 
