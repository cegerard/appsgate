...
/**
 * This class groups the argument for a map/reduce operation and can build the
...
public class MapReduceCommand {
     ...
     * REPLACE - Save the job output to a collection, replacing its previous
     * content MERGE - Merge the job output with the existing contents of
     * outputTarget collection REDUCE - Reduce the job output with the existing
     * contents of outputTarget collection
     */
    ...
    /**
     * Represents the command for a map reduce operation Runs the command in
     * REPLACE output type to a named collection
     * 
     ...
     * @dochub mapreduce
     */
    public MapReduceCommand(DBCollection inputCollection, String map,
	    String reduce, String outputCollection, OutputType type,
	    DBObject query) {
    ...
    /**
     * Gets the output target (name of collection to save to) This value is
     * nullable only if OutputType is set to INLINE
     * 
     ...
     * 
     * @param maxTime
     *            the maximum execution time. A non-zero value requires a server
     *            version >= 2.6
     * @param timeUnit
     *            the time unit that maxTime is specified in
     * @since 2.12.0
     */
    ...
    /**
     * Sets the (optional) database name where the output collection should
     * reside
     * 
     * @param outputDB
     */
    ...
    /**
     * Sets the read preference for this command. See the * documentation for
