...
/**
 * @deprecated BSON type DBPointer(0x0c) is deprecated. Please use a
 *             {@link com.mongodb.DBRef} instead.
 */
@Deprecated
public class DBPointer extends DBRefBase {
    ...
    /**
     * CTOR used for testing BSON encoding. Otherwise non-functional due to a
     * DBRef needing a parent db object, a fieldName and a db
     * 
     * @param ns
     *            namespace to point to
     * @param id
     *            value of _id
     */
