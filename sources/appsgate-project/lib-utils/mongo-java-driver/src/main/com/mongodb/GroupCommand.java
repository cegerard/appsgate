...
/**
 * This class groups the argument for a group operation and can build the
...
public class GroupCommand {
    ...
    public GroupCommand(DBCollection inputCollection, DBObject keys,
	    DBObject condition, DBObject initial, String reduce, String finalize) {
