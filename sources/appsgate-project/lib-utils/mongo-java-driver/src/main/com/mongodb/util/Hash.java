...
public final class Hash {
    ...
    /**
     * Same as longHash(String), using only lower-case values of letters. Calls
     * longhash( s , 0 , s.length() ).
     * 
     * @param s
     *            The string to Hash.
     * @return the hash code
    ...
    /**
     * This is an exact copy of the String <code>hashCode()</code> function,
     * aside from the lowercasing.
     * 
     * @param s
     *            string to be hashed
     * @return the hash code
    ...
    /**
     * This is an exact copy of the String <code>hashCode()</code> function,
     * aside from the lowercasing. No, it's not. It also ignores consecutive
     * whitespace.
     * 
     * @param s
     *            string to be hashed
    ...
    /**
     * Creates a hash code of a lowercase string from [start-end) ignoring
     * whitespace
     * 
     * @param s
     *            string to be hashed
    ...
    /**
     * Creates a hash code of a lowercase string with whitespace removed from
     * [start-end)
     * 
     * @param s
     *            string to be hashed
