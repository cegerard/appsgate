...
public class LazyBSONCallback extends EmptyBSONCallback {
    ...
    /*
     * public Object createObject(InputStream input, int offset) { try { return
     * new LazyBSONObject(input, offset, this); } catch ( IOException e ) {
     * e.printStackTrace(); return null; } }
     */
    private Object _root;

    private static final Logger log = Logger
	    .getLogger("org.bson.LazyBSONCallback");
