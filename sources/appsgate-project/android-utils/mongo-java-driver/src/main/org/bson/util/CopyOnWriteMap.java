 ...
 */
@ThreadSafe
abstract class CopyOnWriteMap<K, V> extends
	AbstractCopyOnWriteMap<K, V, Map<K, V>> {
    /**
	...
	@Override
	public <N extends Map<? extends K, ? extends V>> Map<K, V> copy(
		final N map) {
    ...
    protected abstract <N extends Map<? extends K, ? extends V>> Map<K, V> copy(
	    N map);
}
