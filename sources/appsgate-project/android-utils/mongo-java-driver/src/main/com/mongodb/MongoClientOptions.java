 ...
 * <p/>
 * Note: This class is a replacement for {@code MongoOptions}, to be used with
...
public class MongoClientOptions {
    /**
     * A builder for MongoClientOptions so that MongoClientOptions can be
     * immutable, and to support easier construction through chaining.
     * 
     * @since 2.10.0
     */
	 ...
	 * MBeans, regardless of whether the VM is Java 6 or greater. If false,
	 * the driver will use MXBeans if the VM is Java 6 or greater, and use
	 * MBeans if the VM is Java 5.
	 * 
	 * @param alwaysUseMBeans
	 *            true if driver should always use MBeans, regardless of VM
	 *            version
	 * @return this
	 ...
	 *             if <code>connnectionsPerHost < 1</code>
	 ...
	 */
	public Builder cursorFinalizerEnabled(
	 ...
	 */
	public Builder maxAutoConnectRetryTime(
		final long maxAutoConnectRetryTime) {
	 ...
	 * @throws IllegalArgumentException
	 *             if
	 *             <code>threadsAllowedToBlockForConnectionMultiplier < 1</code>
	...
	public Builder threadsAllowedToBlockForConnectionMultiplier(
		final int threadsAllowedToBlockForConnectionMultiplier) {
    ...
    /**
     * Create a new Builder instance. This is a convenience method, equivalent
     * to {@code new MongoClientOptions.Builder()}.
     * 
	...
	// Compare SocketFactory Class, since some equivalent SocketFactory
    ...
    /**
     * Override the decoder factory. Default is for the standard Mongo Java
    ...
    /**
     * Override the encoder factory. Default is for the standard Mongo Java
     * driver configuration.
     * 
    ...
    /**
     * Gets the description for this MongoClient, which is used in various
     * places like logging and JMX.
     * <p/>
     * Default is null.
     * 
    ...
    /**
     * The read preference to use for queries, map-reduce, aggregation, and
     * count.
     * <p/>
     ...
     * write operations {@link java.net.Socket#setSoTimeout(int)}
     * <p/>
    ...
    /**
     * Gets whether JMX beans registered by the driver should always be MBeans,
    ...
    /**
     * Gets whether there is a a finalize method created that cleans up
