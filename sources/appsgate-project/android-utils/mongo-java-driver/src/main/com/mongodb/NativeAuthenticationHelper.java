...
class NativeAuthenticationHelper {
	...
	ByteArrayOutputStream bout = new ByteArrayOutputStream(
		userName.length() + 20 + password.length);
	try {
    ...
    static DBObject getAuthCommand(String userName, byte[] authHash,
	    String nonce) {
    ...
    static DBObject getAuthCommand(String userName, char[] password,
	    String nonce) {
