...
/**
 * <p>
 * WriteConcern control the acknowledgment of write operations with various
 * options.
 * <p>
 * <b>w</b>
 * <ul>
 ...
 * <li>1 = Wait for acknowledgement, but don't wait for secondaries to replicate
 * </li>
...
public class WriteConcern implements Serializable {
     ...
     * acknowledgement from the primary server before returning. Exceptions are
     ...
     * message is written to the socket. Exceptions are raised for network
    ...
    /**
     * Exceptions are raised for network issues, and server errors; the write
     * operation waits for the server to group commit to the journal file on
     * disk.
     */
    public final static WriteConcern JOURNALED = new WriteConcern(1, 0, false,
	    true);
     ...
     * No exceptions are raised, even for network issues.
     * <p>
     * This field has been superseded by {@code WriteConcern.ERRORS_IGNORED},
     ...
     * issues, but not server errors.
     * <p>
     * This field has been superseded by {@code WriteConcern.UNACKNOWLEDGED},
     * and may be deprecated in a future release.
     * 
     ...
     * raised for network issues, and server errors.
     * <p>
     * This field has been superseded by {@code WriteConcern.ACKNOWLEDGED}, and
     ...
     * operation waits for the server to flush the data to disk.
     * <p>
     * This field has been superseded by {@code WriteConcern.FSYNCED}, and may
     ...
     * disk.
     * <p>
     * This field has been superseded by {@code WriteConcern.JOURNALED}, and may
     * be deprecated in a future release.
     * 
     * @see WriteConcern#JOURNALED
     */
    public final static WriteConcern JOURNAL_SAFE = new WriteConcern(1, 0,
	    false, true);
     ...
     * {@code WriteConcern.REPLICA_ACKNOWLEDGED}, and may be deprecated in a
     * future release.
     * 
    ...
    /**
     * Create a Majority Write Concern that requires a majority of servers to
     ...
     */
    public static Majority majorityWriteConcern(int wtimeout, boolean fsync,
	    boolean j) {
	...
	if (_namedConcerns == null) {
	    HashMap<String, WriteConcern> newMap = new HashMap<String, WriteConcern>(
		    8, 1);
    ...
    Object _w; // this should be final, but can't be because of inadvertent
	       // public setter
    ...
    /**
     * Default constructor keeping all options as default. Be careful using this
     * constructor, as it's equivalent to {@code WriteConcern.UNACKNOWLEDGED},
    ...
    /**
     * Calls {@link WriteConcern#WriteConcern(int, int, boolean)} with w=1 and
     * wtimeout=0
     * 
     * @param fsync
     *            whether or not to fsync
    ...
    /**
     * Calls {@link WriteConcern#WriteConcern(int, int, boolean)} with
     * wtimeout=0 and fsync=false
     * 
     * @param w
     *            number of writes
     */
     ...
     * <p>
     * Specifies the number of servers to wait for on the write operation, and
     ...
     * <li>{@code w=1} Checks server for errors as well as network socket errors
     * raised</li>
     * <li>{@code w>1} Checks servers (w) for errors as well as network socket
     * errors raised</li>
     * </ul>
     * </p>
     * 
     ...
     *            if batch writes should continue after the first error
     */
    public WriteConcern(int w, int wtimeout, boolean fsync, boolean j,
     ...
     *            whether writes should wait for a journaling group commit
     * @param continueOnError
     *            if batched writes should continue after the first error
     * @return
     */
    public WriteConcern(String w, int wtimeout, boolean fsync, boolean j,
	    boolean continueOnError) {
    ...
    /**
     * Toggles the "continue inserts on error" mode. This only applies to server
     * side errors. If there is a document which does not validate in the
     * client, an exception will still be thrown in the client. This will return
     * a new instance of WriteConcern with your preferred continueOnInsert value
     * 
     * @param continueOnError
     */
    public WriteConcern continueOnError(boolean continueOnError) {
	if (_w instanceof Integer) {
	    return new WriteConcern((Integer) _w, _wtimeout, _fsync, _j,
		    continueOnError);
	} else if (_w instanceof String) {
	    return new WriteConcern((String) _w, _wtimeout, _fsync, _j,
		    continueOnError);
	} else {
	    throw new IllegalStateException(
		    "The w parameter must be an int or a String");
	}
    }
     ...
     */
    @Deprecated
    public WriteConcern continueOnErrorForInsert(
	...
	if (_continueOnError != that._continueOnError) {
	    return false;
	}
	if (_fsync != that._fsync) {
	    return false;
	}
	if (_j != that._j) {
	    return false;
	}
	if (_wtimeout != that._wtimeout) {
	    return false;
	}
	if (!_w.equals(that._w)) {
	    return false;
	}
	...
	if (_w instanceof Integer && ((Integer) _w > 1)
		|| (_w instanceof String)) {
	    _command.put("w", _w);
	}
     ...
     * @param w
     *            the value of w.
     * @deprecated construct a new instance instead. This method will be removed
     *             in a future major release, as instances of this class should
     *             really be immutable.
     */
    @Deprecated
    ...
    @Override
    public String toString() {
	return "WriteConcern " + getCommand() + " / (Continue on error? "
