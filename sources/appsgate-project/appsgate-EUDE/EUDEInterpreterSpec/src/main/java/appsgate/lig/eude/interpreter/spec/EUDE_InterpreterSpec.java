...
public interface EUDE_InterpreterSpec {
     ...
     * @return true when succeeded, false when failed a JSON error has been
     * detected
     */
     ...
     * @return true if the program has been successfully launched, false
     * otherwise
     */
