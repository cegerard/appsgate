...
public class NodeExpBool extends Node {
	...
	/** List of boolean sequences. Nodes of the list are separated by a boolean "or" to manage priority of the boolean "and" */
	...
	/**
	 * Called when the interpretation of a sequence is done.
	 * Check if all the sequences of "and" boolean are done. If so, compute the final result and fire the end event
	 * 
	 * @param e 
	 */
	@Override
	 ...
	 * Interpreter simultaneously all the sequences of "and"
	 * 
	 * @return 
	 */
	@Override
