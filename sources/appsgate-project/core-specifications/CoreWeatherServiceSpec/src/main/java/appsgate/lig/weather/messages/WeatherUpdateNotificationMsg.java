/**
 * Copyright 2011-2013 Universite Joseph Fourier, LIG, ADELE team Licensed under
 ...
 * @since 25 juil. 2013
 */
public class WeatherUpdateNotificationMsg extends CoreNotificationMsg {
    ...
    public JSONObject JSONize() {
        JSONObject notif = super.JSONize();
        try {
