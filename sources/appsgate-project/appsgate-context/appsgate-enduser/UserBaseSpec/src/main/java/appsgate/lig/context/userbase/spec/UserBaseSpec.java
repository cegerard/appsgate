...
public interface UserBaseSpec {
	 ...
	 * 
	 * @param id
	 *            the login for this user (must be unique)
	 * @param password
	 *            the password to be authenticate
	 * @param LastName
	 *            the user last name
	 * @param firstName
	 *            the user first name
	 * @param role
	 *            the user role in this home
	 * @return true if the user is correctly added, false otherwise
	 */
	public boolean adduser(String id, String password, String LastName,
	 ...
	 * @param password
	 *            the password of the user to remove
	 ...
	 *            all account detail as JSONObject
	 ...
	 *            the user password
	 * @param accountDetails
	 *            the accountDetial for removal as JSONObject
	...
	/**
	 * 
	 * the object is as this
	 * {'type':'role','value':'nameOfRole','children':[roleObjects]}
	 * 
	 ...
	 * 
	 * @param hierarchy
	 *            the hierarchy entered as a tree
	 */
