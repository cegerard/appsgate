...
public interface PropertyHistoryManager {
	 ...
	 * @return a String that represent DB results as a JSON Object (each deviceId is associated with a JSONArray), example :
	 * {
	 * "deviceID1":[{"time":time_start,"value":"v0"},{"time":t1,"value":"v1"},...,{"time":tn,"value":"vn"} ],
	 * "deviceID2":[...],
	 * ...
	 * }
	 */
	 ...
	 * @return Directly the JSON Object (each deviceId is associated with a JSONArray), example :
	 * {
	 * "deviceID1":[{"time":time_start,"value":"v0"},{"time":t1,"value":"v1"},...,{"time":tn,"value":"vn"} ],
	 * "deviceID2":[...],
	 * ...
	 * }
	 */
	JSONObject getDevicesStatesHistoryAsJSON(Set<String> devicesID, String propertyName, long time_start, long time_end);
