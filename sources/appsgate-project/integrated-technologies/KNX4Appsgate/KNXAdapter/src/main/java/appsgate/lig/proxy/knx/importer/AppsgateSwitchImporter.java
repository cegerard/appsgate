...
public class AppsgateSwitchImporter extends AbstractImporterComponent {

    private static final String APAM_SWITCH_IMPL="KNXOnOffImpl";
    private static final Logger logger = LoggerFactory.getLogger(AppsgateSwitchImporter.class);

        private final BundleContext context;

        private ServiceReference serviceReference;

        @ServiceProperty(name = "target", value = "(&(discovery.knx.device.object=*)(appsgate.type=socket))")
        private String filter;

        @ServiceProperty(name = INSTANCE_NAME_PROPERTY)
        private String name;

        public AppsgateSwitchImporter(BundleContext context) {
