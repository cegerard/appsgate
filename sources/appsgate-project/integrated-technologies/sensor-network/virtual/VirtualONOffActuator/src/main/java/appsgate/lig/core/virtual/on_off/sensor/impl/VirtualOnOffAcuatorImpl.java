package appsgate.lig.core.virtual.on_off.sensor.impl;
 ...
 */
public class VirtualOnOffAcuatorImpl implements CoreObjectSpec, CoreOnOffActuatorSpec {
	
	/**
	 * Static class member uses to log what happened in each instances
	 */
	private static Logger logger = LoggerFactory.getLogger(VirtualOnOffAcuatorImpl.class);
