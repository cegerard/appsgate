package appsgate.lig.led.dfki.impl;
...
public class DFKI_LEDImpl implements CoreOnOffActuatorSpec, CoreObjectSpec {

	/**
	 * Static class member uses to log what happened in each instances
	 */
	private static Logger logger = LoggerFactory.getLogger(DFKI_LEDImpl.class);
