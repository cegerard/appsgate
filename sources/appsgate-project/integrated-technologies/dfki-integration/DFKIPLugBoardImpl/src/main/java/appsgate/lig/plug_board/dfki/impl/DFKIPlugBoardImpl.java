package appsgate.lig.plug_board.dfki.impl;
...
public class DFKIPlugBoardImpl implements CoreObjectSpec, CoreOnOffActuatorSpec {

	/**
	 * Static class member uses to log what happened in each instances
	 */
	private static Logger logger = LoggerFactory.getLogger(DFKIPlugBoardImpl.class);
