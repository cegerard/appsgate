...
(function (root, factory) {
    ...
    _.extend(Debugger.Dashboard.prototype, Backbone.Events, {
        ...
        _init_d3: function () {
            ...
            // Create focusline.
            this._focusline = new Debugger.Widgets.Focusline({id: 'default', orientation: 'bottom'}, focusline_options);
    ...
    _.extend(Widgets.Widget.prototype, Backbone.Events, {
        ...
        initialize: function (options) {
            ...
            // Compute expressions
            this.compute('svg.width', 'this.options.theme.dashboard.width - this.options.theme.dashboard.sidebar.width - this.options.theme.dashboard.widget.margin.left - this.options.theme.dashboard.widget.margin.right');
            this.compute('svg.height', 'this.options.theme.dashboard.widget.height - this.options.theme.dashboard.widget.margin.top - this.options.theme.dashboard.widget.margin.bottom');
    ...
    Widgets.Focusline = Widgets.Widget.extend({
        ...
        onInitD3: function () {
            ...
            this.compute('axis.height', 'this.options.theme.axis.tick.height + this.options.theme.axis.label.height');
            ...
            this.xAxisGroup = this.svg.append("g")
                .attr({
                    ...
                    'transform': 'translate(0,' + (this.computed('svg.height') - this.computed('axis.height'))+ ')'
                })
                .call(this.xAxis);
            ...
            this.context = this.svg.append("g").attr("class", "context").append("g")
                ...
                .selectAll("rect")
                .attr("y", 1)
                .attr("height", this.computed('svg.height') - this.computed('axis.height') - 1);
