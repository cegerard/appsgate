...
public class DeviceNameTableTester {
	...
	public void newInst() {
		...
		String name = deviceNameTable.getUserObjectName(testDeviceId, null);
		...
		logger.debug("@@@@@@@@@@@@@@@@@@@ Try to get the name of a device");
		name = deviceNameTable.getUserObjectName(testDeviceId, null);
		logger.debug("       @@@@@@@@@@@@ Device name get: "+name);
		
		logger.debug("@@@@@@@@@@@@@@@@@@@ Try to get the name of a device for a non existing user");
		name = deviceNameTable.getUserObjectName(testDeviceId, "plop");
		logger.debug("       @@@@@@@@@@@@ Device name get: "+name);
